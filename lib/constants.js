...
/** Recepcionista y administrador comparten operación diaria (agenda, clientes). */
export const ROLES_OPERATIVO = ["recepcionista", "administrador"];

export function isRolOperativo(rol) {
  return ROLES_OPERATIVO.includes(rol);
}
